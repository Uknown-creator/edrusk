...
/**
 * Strings for component 'tool_brickfield', language 'ru', version '3.11'.
 *
...
$string['activityresults:pluginname'] = 'Отчет инструмента общедоступности с разбивкой по активности';
$string['activityresults:toolname'] = 'Сводка по активности';
$string['activityresults:toolshortname'] = 'Разбивка по активности';
...
$string['error:nocoursespecified'] = 'Для этого сводного отчета требуется действительный ID курса. Получите доступ к инструментарию общедоступности из курса через меню действий, в котором будет представлен этот требуемый ID курса.';
...
$string['settings'] = 'Настройки инструментария доступности';
...
$string['titleactivityresultspartial'] = '';
